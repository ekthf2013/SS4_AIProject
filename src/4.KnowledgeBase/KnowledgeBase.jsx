  ...
  return (
    <PremiumPage theme={theme}>
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
        <SectionHeader title={t('vault_title')} subtitle={t('vault_sub')} theme={theme} />
        <div className={cn(
      ...
      {kbTab === 'vault' && (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <Card theme={theme} className="lg:col-span-1 h-[600px] overflow-y-auto">
                  ...
                  <div key={doc.id} className="relative group">
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <p className={cn(
                          "text-sm font-bold leading-tight break-all",
                          theme === 'dark' ? "text-slate-100" : "text-gray-900"
                        )}>{doc.title ? doc.title.replace(/\.[^/.]+$/, "") : 'Untitled Document'}</p>
                      </div>
                    </button>
                  </div>
                ))
          ...
          <Card theme={theme} className="lg:col-span-2 h-[600px] flex flex-col shadow-sm overflow-hidden p-0">
            {selectedDoc ? (
              <div className="flex flex-col h-full w-full">
                <div className={cn(
                  "px-6 py-4 border-b flex justify-between items-center z-10 shrink-0",
                ...
                <div className={cn(
                  ...
                  <h2 className={cn(
                    ...
                    theme === 'dark' ? "text-slate-100 border-slate-700" : "text-gray-900 border-gray-100"
                  )}>{selectedDoc.title ? selectedDoc.title.replace(/\.[^/.]+$/, "") : 'Untitled Document'}</h2>

                  <div className={cn(
                    "mb-8 p-6 rounded-2xl border relative",
                    theme === 'dark' ? "bg-blue-900/10 border-blue-800/50" : "bg-blue-50/50 border-blue-100"
                  )}>
