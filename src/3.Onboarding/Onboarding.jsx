                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <Card theme={theme}>
                      <div className="flex flex-col items-center justify-center p-4">
                        ...
                        <p className="text-xs font-bold text-gray-500 uppercase tracking-widest">{'전체 팀원'}</p>
                        <p className={cn(
                    ...
                    <Card theme={theme}>
                      <div className="flex flex-col items-center justify-center p-4">
                        ...
                        <p className="text-xs font-bold text-gray-500 uppercase tracking-widest">{'평균 진척률'}</p>
                        <p className={cn(
                          "text-3xl font-black mt-1",
                          theme === 'dark' ? "text-slate-100" : "text-gray-900"
                        )}>{teamStats?.avg}%</p>
                    ...
                    <Card theme={theme}>
                      <div className="flex flex-col items-center justify-center p-4">
                        ...
                        <p className="text-xs font-bold text-gray-500 uppercase tracking-widest">{'완료 인원'}</p>
                        <p className={cn(
                          "text-3xl font-black mt-1",
                          theme === 'dark' ? "text-slate-100" : "text-gray-900"
